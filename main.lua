...
local function gruvbox_material_dark_theme(toughness)
	...
	return {
		...
		files = { icon = "", fg = gruvbox_material_dark_palette.blue },
	    filtereds = { icon = "", fg = gruvbox_material_dark_palette.purple },

		total = { icon = "󰮍", fg = gruvbox_material_dark_palette.yellow },
		success = { icon = "", fg = gruvbox_material_dark_palette.green },
		failed = { icon = "", fg = gruvbox_material_dark_palette.red },

		-- yatline-githead
		branch_color = gruvbox_material_dark_palette.blue,
		remote_branch_color = gruvbox_material_dark_palette.purple,
		tag_color = gruvbox_material_dark_palette.aqua,
		commit_color = gruvbox_material_dark_palette.purple,
		behind_remote_color = gruvbox_material_dark_palette.orange,
		ahead_remote_color = gruvbox_material_dark_palette.aqua,
...
local function gruvbox_material_light_theme(toughness)
	...
	return {
		...
		files = { icon = "", fg = gruvbox_material_light_palette.blue },
	    filtereds = { icon = "", fg = gruvbox_material_light_palette.purple },

		total = { icon = "󰮍", fg = gruvbox_material_light_palette.yellow },
		success = { icon = "", fg = gruvbox_material_light_palette.green },
		failed = { icon = "", fg = gruvbox_material_light_palette.red },

		-- yatline-githead
		branch_color = gruvbox_material_light_palette.blue,
		remote_branch_color = gruvbox_material_light_palette.purple,
		tag_color = gruvbox_material_light_palette.aqua,
		commit_color = gruvbox_material_light_palette.purple,
		behind_remote_color = gruvbox_material_light_palette.orange,
		ahead_remote_color = gruvbox_material_light_palette.aqua,
